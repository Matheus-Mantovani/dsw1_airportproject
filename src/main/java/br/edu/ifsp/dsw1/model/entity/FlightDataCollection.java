...
public class FlightDataCollection implements FlightDataSubject{
	...
	private void adicionarAvioes() { //TEMPORARIO, APAGAR DEPOIS
		...
		FlightData a2 = new FlightData(1432L, "Companhia1", "15:22");
		FlightData a3 = new FlightData(456L, "Companhia1", "08:12");
		FlightData a4 = new FlightData(634L, "Companhia1", "21:57");
		FlightData a5 = new FlightData(632L, "Companhia1", "23:23");
		...
		updateFlight(123L);
		updateFlight(634L); // deve estar em tookingoff
		updateFlight(634L);
	}
}
